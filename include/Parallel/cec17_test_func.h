#ifndef SMART_O2CPP_CEC17_TEST_FUNC_H_H
#define SMART_O2CPP_CEC17_TEST_FUNC_H_H
...
{
    class Individual;
    class CEC2017Problems
    {
    public:
        void cec17_init(int nx, int func_num);
        void evaluate(Individual &ind, int n, int m, int func_num);
    ...
    private:
        ...
        void
        step_rastrigin_func(double *, double *, int, double *, double *, int, int); /* Noncontinuous Rastrigin's  */
