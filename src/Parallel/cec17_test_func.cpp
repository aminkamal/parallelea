...
namespace Parallel
{
    void CEC2017Problems::cec17_init(int nx, int func_num) {
        int cf_num = 10, i, j;
        if (ini_flag == 1) {
        ...
        if (ini_flag == 0) {
            ...
            /* Load Matrix M*/
            sprintf(FileName, "cec2017_bound_constrained_input_data/M_%d_D%d.txt", func_num, nx);
            ...
            /* Load shift_data */
            sprintf(FileName, "cec2017_bound_constrained_input_data/shift_data_%d.txt", func_num);
            fpt = fopen(FileName, "r");
            if (fpt == NULL) {
                printf("\n Error: Cannot open input file for reading \n");
            }
            ...
            if (func_num >= 11 && func_num <= 20) {
                sprintf(FileName, "cec2017_bound_constrained_input_data/shuffle_data_%d_D%d.txt", func_num, nx);
                fpt = fopen(FileName, "r");
                if (fpt == NULL) {
                    printf("\n Error: Cannot open input file for reading \n");
                }
    ...
    void CEC2017Problems::evaluate(Individual &ind, int n, int m, int func_num)
    {
        double fit;
        cec17_test_func(&ind.getMembers()[0], &fit, n,m,func_num);
        ind.setFitness(fit);
    }

    void CEC2017Problems::cec17_test_func(double *x, double *f, int nx, int mx, int func_num) {
        int i, j;
        for (i = 0; i < mx; i++) {
            switch (func_num) {
                case 1:
...
*/
    ...
    void CEC2017Problems::sphere_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
                                      int r_flag) /* Sphere */
    {
        int i;
        f[0] = 0.0;
    ...
    void CEC2017Problems::ellips_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::sum_diff_pow_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::zakharov_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
                                        int r_flag) /* zakharov */
    {
        int i;
        sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag); // shift and rotate
...
/* Levy function */
    void
    CEC2017Problems::levy_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag, int r_flag) /* Levy */
    {
        int i;
        f[0] = 0.0;
        sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag); /* shift and rotate */
...
/* Dixon and Price */
    void CEC2017Problems::dixon_price_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::bent_cigar_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::discus_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
                                      int r_flag) /* Discus */
    {
        int i;
        sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag); /* shift and rotate */
    ...
    void CEC2017Problems::dif_powers_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::rosenbrock_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::schaffer_F7_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::ackley_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
                                      int r_flag) /* Ackley's  */
    {
        int i;
        double sum1, sum2;
    ...
    void CEC2017Problems::weierstrass_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::griewank_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::rastrigin_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::step_rastrigin_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::schwefel_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::katsuura_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
                                        int r_flag) /* Katsuura  */
    {
        int i, j;
    ...
    void CEC2017Problems::bi_rastrigin_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::grie_rosen_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::escaffer6_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
    ...
    void CEC2017Problems::happycat_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
...
/* original global optimum: [-1,-1,...,-1] */
    ...
    void CEC2017Problems::hgbat_func(double *x, double *f, int nx, double *Os, double *Mr, int s_flag,
...
/* original global optimum: [-1,-1,...,-1] */
    ...
    void CEC2017Problems::hf01(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
    ...
    void CEC2017Problems::hf02(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
    ...
    void CEC2017Problems::hf03(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
                               int r_flag) /* Hybrid Function 2 */
    {
        int i, tmp, cf_num = 3;
        double fit[3];
    ...
    void CEC2017Problems::hf04(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
    ...
    void CEC2017Problems::hf05(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
    ...
    void CEC2017Problems::hf06(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
    ...
    void CEC2017Problems::hf07(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
    ...
    void CEC2017Problems::hf08(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
                               int r_flag) /* Hybrid Function 6 */
    {
        int i, tmp, cf_num = 5;
        double fit[5];
    ...
    void CEC2017Problems::hf09(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
                               int r_flag) /* Hybrid Function 6 */
    {
        int i, tmp, cf_num = 5;
        double fit[5];
    ...
    void CEC2017Problems::hf10(double *x, double *f, int nx, double *Os, double *Mr, int *S, int s_flag,
                               int r_flag) /* Hybrid Function 6 */
    {
        int i, tmp, cf_num = 6;
        double fit[6];
    ...
    void
    CEC2017Problems::cf01(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 1 */
    {
        int i, cf_num = 3;
        double fit[3];
    ...
    void
    CEC2017Problems::cf02(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 2 */
    {
        int i, cf_num = 3;
        double fit[3];
        double delta[3] = {10, 20, 30};
    ...
    void
    CEC2017Problems::cf03(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 3 */
    {
        int i, cf_num = 4;
        double fit[4];
    ...
    void
    CEC2017Problems::cf04(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 3 */
    {
        int i, cf_num = 4;
        double fit[4];
        double delta[4] = {10, 20, 30, 40};
    ...
    void
    CEC2017Problems::cf05(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 4 */
    {
        int i, cf_num = 5;
        double fit[5];
    ...
    void
    CEC2017Problems::cf06(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 4 */
    {
        int i, cf_num = 5;
        double fit[5];
    ...
    void
    CEC2017Problems::cf07(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 4 */
    {
        int i, cf_num = 6;
        double fit[6];
    ...
    void
    CEC2017Problems::cf08(double *x, double *f, int nx, double *Os, double *Mr, int r_flag) /* Composition Function 4 */
    {
        int i, cf_num = 6;
        double fit[6];
        double delta[6] = {10, 20, 30, 40, 50, 60};
    ...
    void CEC2017Problems::cf09(double *x, double *f, int nx, double *Os, double *Mr, int *SS, int r_flag) {
    ...
    void CEC2017Problems::cf10(double *x, double *f, int nx, double *Os, double *Mr, int *SS, int r_flag) {
        int i, cf_num = 3;
        double fit[3];
        double delta[3] = {10, 30, 50};
        double bias[3] = {0, 100, 200};
    ...
    void CEC2017Problems::shiftfunc(double *x, double *xshift, int nx, double *Os) {
        int i;
        for (i = 0; i < nx; i++) {
            xshift[i] = x[i] - Os[i];
        }
    ...
    void CEC2017Problems::rotatefunc(double *x, double *xrot, int nx, double *Mr) {
        int i, j;
        for (i = 0; i < nx; i++) {
            xrot[i] = 0;
            for (j = 0; j < nx; j++) {
    ...
    void CEC2017Problems::sr_func(double *x, double *sr_x, int nx, double *Os, double *Mr, double sh_rate, int s_flag,
    ...
    void CEC2017Problems::asyfunc(double *x, double *xasy, int nx, double beta) {
        int i;
        for (i = 0; i < nx; i++) {
            if (x[i] > 0)
    ...
    void CEC2017Problems::oszfunc(double *x, double *xosz, int nx) {
        int i, sx;
        double c1, c2, xx;
        for (i = 0; i < nx; i++) {
            if (i == 0 || i == nx - 1) {
    ...
    void CEC2017Problems::cf_cal(double *x, double *f, int nx, double *Os, double *delta, double *bias, double *fit,
                                 int cf_num) {
        int i, j;
        double *w;
